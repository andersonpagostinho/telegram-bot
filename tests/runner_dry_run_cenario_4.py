#!/usr/bin/env python3
"""
DRY_RUN RUNNER CENÁRIO 4 — conflito de horário.
Valida se o router bloqueia confirmação e oferece sugestões.
"""
...
async def main():
    ...
    caminho = Path(__file__).parent / "resultado_dry_run_cenario_4.json"
