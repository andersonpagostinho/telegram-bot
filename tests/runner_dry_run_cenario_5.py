#!/usr/bin/env python3
"""
DRY_RUN RUNNER CENÁRIO 5 — conflito com profissional alternativo.
Valida se o router oferece outro profissional disponível no mesmo horário.
"""
...
async def main():
    ...
    async def conflito_com_alternativo_mock(*args, **kwargs):
        ...
        return {
            "conflito": True,
            "sugestoes": ["10:40", "11:20"],
            "profissional_alternativo": "Carla",
        }

    pr.verificar_conflito_e_sugestoes_profissional = conflito_com_alternativo_mock
    ...
    contexto_mock.storage[user_id] = {
        "historico_texto": ["quero agendar escova amanhã às 10"],
    ...
    caminho = Path(__file__).parent / "resultado_dry_run_cenario_5.json"
