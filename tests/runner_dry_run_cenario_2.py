#!/usr/bin/env python3
"""
DRY_RUN RUNNER CENÁRIO 2 — Executa cenário com contexto do cenário 1
Estratégia: monkey-patch direto no namespace do router + carregar contexto pré-existente
"""
...
async def main():
    ...
    # Carregar contexto do cenário 1 no mock
    contexto_mock.storage[user_id] = contexto_cenario_1
    ...
    caminho = Path(__file__).parent / "resultado_dry_run_cenario_2.json"
