...
Estratégia: capture a chamada a criar_evento sem executar a ação real
"""
...
async def main():
    ...
    if hasattr(pr, "executar_acao_gpt"):
        pr.executar_acao_gpt = executar_acao_gpt_mock

    user_id = "user_novo_teste_001"

    # Contexto final do cenário 2 (após resposta "Bruna")
    contexto_cenario_2_final = {
    ...
    # Carregar contexto do cenário 2 no mock
    contexto_mock.storage[user_id] = contexto_cenario_2_final
    ...
    relatorio = {
        ...
        "input": input_data,
        "contexto_inicial": contexto_cenario_2_final,
        "output": output_data,
        "erro": erro,
    ...
    caminho = Path(__file__).parent / "resultado_dry_run_cenario_3.json"
